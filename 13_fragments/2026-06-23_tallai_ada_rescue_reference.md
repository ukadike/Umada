- id: FRAG-2026-06-23-TALLAI-ADA-RESCUE
- date: 2026-06-23
- source: AI image generation (DALL-E). Approved by Kemi as locked reference canon
  ("Lock all five"), with explicit confirmation that the caregiver shown is Tallai and
  that Tallai is herself a chimera, not merely a specialist who treats chimeras.
- type: image
- raw content: |
...
- accessibility concepts: will need alt text/plain-language description before public use.
- emotional memory: a tender, protective caregiving gesture — coheres with Tallai's
  locked "care specialist" role.
- visual language: chimera physiology (scales, crest, claws) worn openly, not hidden;
  white care-coat/robe with an organizational patch.
- episode opportunities: none noted.
- fanbase opportunities: none noted.

## Canon

- proposed status: LOCKED (Kemi-approved, 2026-06-23).
- target files: `02_characters/TALLAI_DOSSIER.md` (new), `02_characters/ADA_DOSSIER.md`,
  `data/characters.json`, `data/visual_artifacts.json`, `00_governance/CANON_STATUS.md`.
